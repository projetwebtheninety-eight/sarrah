                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            ...
                            <form name="f"  action="ajoutproduit.php" class="tm-edit-product-form"  method="post"  enctype="multipart/form-data" onsubmit="return verifForm(this)">
                                <div class="input-group mb-3">
                                    ...
                                    <input  type="text" name="nom" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7 "  onblur="verifname(this);">
                                </div>

                                <div class="input-group mb-3">
                                    <label for="reference" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Reference
                                    </label>
                                    <input type="text" name="reference" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7" onblur="verifref(this);" >
                                    </div>
                                                                <div class="input-group mb-3">
<label class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Categorie</label>
 
<select class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7" id="" name="categorie" type="text" name="categorie" >
...
?>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="prix" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
